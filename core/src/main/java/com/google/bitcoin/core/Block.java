...
public class Block extends Message {
    ...
    public BigInteger getBlockInflation(int height) {
        ...
        return /*Utils.toNanoCoins(*/CoinDefinition.GetBlockReward(height, getNormalizedDifficulty())/*, 0)*/;
    }
    ...
    */
    ...
    public double getNormalizedDifficulty() {
        int nBits = (int) (difficultyTarget);
